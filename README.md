...
int main() {
    ZCLibLog::LoggerSync<ZCLibLog::formatters::format> logger{
        "MainLogger",
        {
            ZCLibLog::NewExecutor<ZCLibLog::executors::cstdout>()
        },
...
int main() {
    ZCLibLog::LoggerSync<> logger{
        "DefaultFmt",
        {
            ZCLibLog::NewExecutor<ZCLibLog::executors::iostream>()
        },
...
ZCLibLog::LoggerSync<> logger{
    "FileLogger",
    { ZCLibLog::NewExecutor<FileExecutor>("app.log") },
    ZCLibLog::LogLevel_DEBUG
};
```
...
size_t id = logger.bind_executor(ZCLibLog::NewExecutor<ZCLibLog::executors::cstdout>());
...
ZCLibLog::LoggerSync<ZCLibLog::formatters::android_log> logger{
    "AndroidLogger",
    { ZCLibLog::NewExecutor<ZCLibLog::executors::android_log>("MyApp") },
    ZCLibLog::LogLevel_INFO
};
```
